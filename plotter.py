...
chart_fcfs.axis([-1.03, 0.05, 0, 27])
...
chart_fcfs.plot([-1, 0], [25, 3], marker="o", markeredgecolor=markercolors[0], markerfacecolor=markercolors[0])
chart_fcfs.plot([-1.03, 0.1], [17, 17], "--", color="orange")
